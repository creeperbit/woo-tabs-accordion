(function($) {
    $.fn.accordion = function(options) {
        return this.each(function() {
            ...
            if (settings.allChildsOpen == true) {
                $(this).find(".accordion-header").toggleClass("accordion-header-active");
                $(this).find(".accordion-header").parent().toggleClass("accordion-item-active");
                $(this).find(".accordion-header").next().slideToggle(0);
                $(this).find(".accordion-header").children(".accordion-header-icon").toggleClass("accordion-header-icon-active");
            }
